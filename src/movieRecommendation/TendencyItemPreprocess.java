...
public class TendencyItemPreprocess {
	...
	public static void main(String[] args) throws Exception {
	     JobConf conf = new JobConf(TendencyItemPreprocess.class);
	     conf.setJobName("TendencyItemPreprocess");
	     ...
	     FileSystem.get(conf).delete(new Path("TendencyItemPreprocess"), true);
	     FileOutputFormat.setOutputPath(conf, new Path("TendencyItemPreprocess"));
	     MainDriver.run(conf);
	   }
}
