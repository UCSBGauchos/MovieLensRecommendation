...
public class MainDriver {
	public static void main(String [] argv){
		...
		try{
			...
			driver.addClass("userknn", ItemKNNMain.class, "Do item-based KNN on the preprocessed input data");
			...
			driver.addClass("startuserquery", ItemQuery.class, "Start user-based collaborative algorithm to predict the rating. Make sure you have run collect, preprocess and knn command");
			driver.driver(argv);
			exitCode = 0;
		}catch(Throwable e){
			e.printStackTrace();
